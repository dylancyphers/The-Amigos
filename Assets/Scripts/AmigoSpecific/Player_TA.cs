...
//[AddComponentMenu("Sample Game Glue Code/The-Amigos/Top Down Player Controller")]

public class Player_TA: BaseTopDown
{
	...
	void LostLife()
	{
		...
		// blow us up!
		GameController_TA.Instance.PlayerHit( myTransform );
	...
	public void PlayerFinished()
	{
		...
		GameController_TA.Instance.PlayerDied( id );
