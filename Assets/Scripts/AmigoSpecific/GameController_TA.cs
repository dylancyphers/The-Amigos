...
[AddComponentMenu("Sample Game Glue Code/The-Amigos/Game Controller")]

public class GameController_TA : BaseGameController
{
    public string mainMenuSceneName = "menu_TA";
    ...
    private Player_TA thePlayerScript;
    private Player_TA focusPlayerScript;
    ...
    public UI_TA UIControl;

    [System.NonSerialized]
    public static GameController_TA Instance;
    ...
    public void Init()
    {
        ...
        for (int i = 0; i < numberOfPlayers; i++)
        {
            ...
            Player_TA tempController = tempT.GetComponent<Player_TA>();
        ...
        thePlayerScript = (Player_TA)playerGO1.GetComponent<Player_TA>();
    ...
    */
    ...
    public Player_TA GetMainPlayerScript()
    {
